...
function acf_blocks()
{
    if (function_exists('acf_register_block_type')) {
        ...
        acf_register_block_type(array(
            'name'				=> 'cb_gardener_carousel',
            'title'				=> __('CB Gardener Carousel'),
            'category'			=> 'layout',
            'icon'				=> 'cover-image',
            'render_template'	=> 'page-templates/blocks/cb_gardener_carousel.php',
            'mode'	=> 'edit',
            'supports' => array('mode' => false),
        ));
        acf_register_block_type(array(
            'name'				=> 'cb_gardener_list',
            'title'				=> __('CB Gardener List'),
            'category'			=> 'layout',
            'icon'				=> 'cover-image',
            'render_template'	=> 'page-templates/blocks/cb_gardener_list.php',
            'mode'	=> 'edit',
            'supports' => array('mode' => false),
        ));
        acf_register_block_type(array(
        ...
        acf_register_block_type(array(
            'name'				=> 'cb_doclist',
            'title'				=> __('CB Document List'),
            'category'			=> 'layout',
            'icon'				=> 'cover-image',
            'render_template'	=> 'page-templates/blocks/cb_doclist.php',
            'mode'	=> 'edit',
            'supports' => array('mode' => false),
        ));
        acf_register_block_type(array(
        ...
        acf_register_block_type(array(
            'name'				=> 'cb_job_schema',
            'title'				=> __('CB Job Schema'),
            'category'			=> 'layout',
            'icon'				=> 'cover-image',
            'render_template'	=> 'page-templates/blocks/cb_job_schema.php',
            'mode'	=> 'edit',
            'supports' => array('mode' => false),
        ));
    }
